...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/nvim-compe",
    url = "https://github.com/hrsh7th/nvim-compe"
  },
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
